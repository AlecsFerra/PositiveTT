...
theorem Ren.WellTyped.lift {r : Ren n m} (hr : Ren.WellTyped r Γ Δ) :
...
theorem Ren.WellTyped.lift2 {r : Ren n m} (hr : Ren.WellTyped r Γ Δ) :
...
theorem WfTm.weaken (ht : Γ ⊢ t ∶ τ) (hΓσ : ⊢ Γ ∷ σ) :
    Γ ∷ σ ⊢ ↑ t ∶ ↑ τ :=
  DefEq.weaken ht hΓσ
